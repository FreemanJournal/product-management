...
export default function Delete() {
  const {setIsDelConfirm,setShowModal} = useContext(ProductDataContext)
  return (
    <>
        ...
        <div className="w-full h-full text-center">
          <div className="flex h-full flex-col justify-between">
            <svg
              width="40"
              height="40"
              className="mt-4 w-12 h-12 m-auto text-green-500"
              fill="currentColor"
            ...
            <div className="flex items-center justify-between gap-4 w-full mt-8">
              ...
              <button
                type="button"
                className="py-2 px-4  bg-white hover:bg-gray-100 focus:ring-green-500 focus:ring-offset-green-200 text-green-500  w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
